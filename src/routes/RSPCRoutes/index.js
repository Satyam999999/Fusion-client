export const BASE = "/research_procedures/api";
export const STAFF_BASE = "/research_procedures/api";
export const GOVERNANCE_BASE = "/research_procedures/api";
...
export const updateProjectStatusRoute  = (id) => `${BASE}/projects/${id}/update_status/`;
export const projectDetailsRoute = (id) => `${BASE}/projects/${id}/project_details/`;
export const modifyProjectDurationRoute = (id) => `${BASE}/projects/${id}/modify_duration/`;
export const downloadProjectPdfRoute = (id) => `${BASE}/projects/${id}/download_pdf/`;
export const approveExpenditureRoute   = (id) => `${BASE}/expenditures/${id}/approve/`;
export const rejectExpenditureRoute    = (id) => `${BASE}/expenditures/${id}/reject/`;
export const verifyPublicationRoute    = (id) => `${BASE}/publications/${id}/verify/`;
export const updatePatentStatusRoute   = (id) => `${BASE}/patents/${id}/update_status/`;
export const updateScholarStatusRoute  = (id) => `${BASE}/scholars/${id}/update_status/`;

export const forwardApprovalRoute = (id) => `${GOVERNANCE_BASE}/approval-requests/${id}/forward/`;
export const approveApprovalRoute = (id) => `${GOVERNANCE_BASE}/approval-requests/${id}/approve/`;
export const rejectApprovalRoute = (id) => `${GOVERNANCE_BASE}/approval-requests/${id}/reject/`;
...
export const documentHistoryRoute = (id) => `${GOVERNANCE_BASE}/documents/${id}/history/`;
export const approveClosureRoute = (id) => `${GOVERNANCE_BASE}/closure-requests/${id}/approve/`;
export const evaluateRuleRoute = (id) => `${GOVERNANCE_BASE}/rules/${id}/evaluate/`;
export const executeAutomationRoute = (id) => `${GOVERNANCE_BASE}/automation-rules/${id}/execute/`;
export const modifyStaffTenureRoute = (id) => `${STAFF_BASE}/appointments/${id}/modify_tenure/`;