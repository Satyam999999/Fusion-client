...
import { fetchPublicationsRoute } from "../../routes/RSPCRoutes";
...
function Publications() {
  ...
  const handleSubmit = async () => {
    if (!form.title || !form.journal_conference_name) {
      notifications.show({
        title: "Validation",
        message: "Title and journal are required",
        color: "red",
      });
      return;
    }
  ...
  // Only Faculty and RSPC Admin can add publications
  if (can("add_publication")) {
    tabItems.push({
          ...
          <Grid gutter="md">
            ...
            <Grid.Col span={{ base: 12, sm: 6 }}>
              <Select
                ...
                onChange={(v) =>
                  setForm((f) => ({ ...f, publication_type: v }))
                }
              />
            </Grid.Col>
            <Grid.Col span={{ base: 12, sm: 6 }}>
            ...
            <Grid.Col span={{ base: 12, sm: 6 }}>
              <TextInput
                ...
                value={form.external_authors}
                onChange={(e) =>
                  setForm((f) => ({ ...f, external_authors: e.target.value }))
                }
              />
            </Grid.Col>
            <Grid.Col span={{ base: 12 }}>
